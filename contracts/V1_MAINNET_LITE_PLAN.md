...
|---|---|---|
| Гонорари, розподіл 50/50 | `TipJar.sol` (`councilAuthorBps=5000`, `shieldAuthorBps=5000`, `noneAuthorBps=5000`) | Спліт автор/пул уже 50/50 за замовчуванням; голосуванням ДАО частку пулу можна лише збільшувати в межах [50%;95%] — тобто частка автора може лише зменшуватись, у межах [5%;50%] |
