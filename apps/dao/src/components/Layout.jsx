...
export default function Layout() {
  ...
  const handleDisconnect = useGuardedDisconnect(dao, loggingOutRef);
    ...
    <div className="min-h-screen flex bg-ink">
      ...
      {showOnboarding && (
        <OnboardingOverlay
          ...
          onDisconnect={() => {
            // showOnboarding is only ever reset by onDone (see the
            // effect above) — disconnecting doesn't imply it, so without
            // this the overlay would keep rendering on top of a
            // now-disconnected dao.account after handleDisconnect() runs.
